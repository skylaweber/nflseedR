...
The season simulation code for nflseedR 1.x was developed by Lee Sharpe ([\@LeeSharpeNFL](https://x.com/LeeSharpeNFL)) and building it as package was developed by Sebastian Carl ([\@mrcaseb](https://mrcaseb.com)). 

nflseedR 2.0 introduced high efficient standings and simulation functionality which was developed by Sebastian Carl ([\@mrcaseb](https://mrcaseb.com))
